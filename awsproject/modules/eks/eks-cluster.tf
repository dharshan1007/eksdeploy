# EKS Cluster
resource "aws_eks_cluster" "ev_pilot_innova" {
  name     = "${var.solution}-${var.environment}-cluster"
...
resource "aws_iam_role" "cluster" {
  name = "${var.solution}-${var.environment}-Cluster-Role"
...
resource "aws_security_group" "eks_cluster" {
  name        = "${var.solution}-${var.environment}-cluster-sg"
